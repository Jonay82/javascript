...
for (let i = 0; i < users.length; i++) {
    ...
    if(user.years<=18){
        console.log ( "Usuario menor de edad:" +" "+ user.name +' tiene'+' '+ user.years);
    }else{
        console.log("Usuario mayor de edad:" +" "+ user.name +' tiene'+' '+ user.years);
    }
}


//console.log("Usuario menor de edad:" +" "+ users.years[i], "Usuario menor de edad:" +" "+ users.years[i])
