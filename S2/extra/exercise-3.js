...
for ( const user of users){
    // para cada usuario recorrer sus sonidos favoritos
        for (const soundType in user.favoritesSounds){
            // para cada sonido favorito
                // si no está en el array, se inicializa 
                if( soundTypes[soundType] == undefined){
                    soundTypes[soundType] = 0;
                }
