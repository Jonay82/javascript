...
const list = streamers.filter((gameMay) =>{
    if (gameMay.gameMorePlayed.includes('Legends')&& gameMay.age>=35){
        gameMay.gameMorePlayed=gameMay.gameMorePlayed.toLocaleUpperCase();
    } 
        return(gameMay)
})
